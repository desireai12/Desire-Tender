...
export const DEFAULT_PROJECT_CONFIGS: Record<ProjectCategory, ProjectAIConfig> = {
  SOLAR: {
    ...
    system_instruction: 'SOLAR Project Tender Instruction: Universally analyze Solar PV EPC tenders (Ground Mounted, Floating & Rooftop Solar PV Plants). Dynamically extract target tender specifications including MWp/KWp capacity ratings, PV module efficiency & ALMM compliance, central/string inverter specs, solar yield forecasting, net-metering & grid interconnection, and 5 to 25-Year Comprehensive O&M terms. Evaluate extracted clauses against Desire Energy (₹300.93 Cr 3-Yr Avg Turnover, ₹95.00 Cr Net Worth, 50+ MW Solar PV execution, Class-1 Electrical License) and JV Partner credentials.',
    eligibility_logic: 'Dynamic Tender Eligibility Rules: Extract target tender\'s turnover, solar capacity execution (MW/KW), and MNRE/Nodal empanelment criteria directly from the tender document. Evaluate Option 1 (Desire Alone: ₹300.93 Cr Turnover, 50+ MW Solar PV, Class-1 Electrical License), Option 2 (JV Partner Alone: Partner Turnover & Solar execution), and Option 3 (Combined Consortium: Financial Pooling + Combined Solar EPC & Grid Interconnection Strength).',
  ...
  RHDS: {
    ...
    system_instruction: 'RHDS Project Tender Instruction: Universally analyze Rural High Density & Drinking Water Supply tenders (e.g. Jal Jeevan Mission, Multi-Village Schemes, Bulk Water Distribution). Dynamically extract target tender specifications including HDPE/DI/MS pipeline pressure ratings (PN-10/16) & diameter, Overhead Service Reservoir (OHSR/CWR) capacities, raw water intake works, pumping stations, chlorination units, and O&M terms. Evaluate extracted clauses against Desire Energy\'s premier JJM track record (1,00,000+ village connections, ₹300.93 Cr 3-Yr Avg Turnover, ₹95.00 Cr Net Worth) and JV partner capabilities.',
    eligibility_logic: 'Dynamic Tender Eligibility Rules: Extract target tender\'s exact financial limits (Turnover, Net Worth, Solvency, EMD) and physical pipeline execution requirements directly from the tender document. Evaluate Option 1 (Desire Alone: ₹300.93 Cr Turnover, ₹95.00 Cr Net Worth, 120+ km Pipeline, PHED Class-A Special License), Option 2 (JV Partner Alone: Partner Turnover & Regional Distribution Experience), and Option 3 (Combined Consortium: 100% Financial Pooling + Technical Synergy with Desire as Lead Member).',
  ...
  KUSUM: {
    ...
    system_instruction: 'KUSUM Project Tender Instruction: Universally analyze PM-KUSUM (Component A/B/C) Solar Pumping & Grid-Connected Agricultural Solarization tenders. Dynamically extract target tender specifications including solar pump HP ratings (3 HP to 10 HP AC/DC Submersible/Surface), Sunaquator RMS 4G IoT telemetry controllers, MNRE technical specs, and 5-Year mandatory warranty/O&M compliance. Evaluate extracted clauses against Desire Energy (₹94 Cr PM-KUSUM Component-B execution, In-house RMS Telemetry Platform, ₹300.93 Cr Turnover).',
    eligibility_logic: 'Dynamic Tender Eligibility Rules: Extract target tender\'s turnover, solar pump count requirements, and Nodal Agency empanelment terms directly from the tender document. Evaluate Option 1 (Desire Alone: ₹300.93 Cr Turnover, ₹94 Cr PM-KUSUM execution, In-house RMS platform), Option 2 (JV Partner Alone), and Option 3 (Combined Consortium: Financial Pooling + Solar Pump Delivery).',
    costing_methodology: 'Item-level matching against State Nodal Agency (RRECL/GEDA/HAREDA) PM-KUSUM benchmark costs per HP for pump sets, solar panels, RMS controllers, and mounting structures.',
  ...
  EPC: {
    ...
    system_instruction: 'EPC Project Tender Instruction: Universally analyze Turnkey EPC Infrastructure tenders across Water Transmission, Civil Engineering, Pipelines, and Electromechanical Works. Dynamically extract target tender specifications including financial turnover, single work order value thresholds, pipeline laying & jointing lengths, pumping plant kW ratings, sub-station/electrical works, and milestone timelines. Evaluate extracted clauses against Desire Energy (₹300.93 Cr Turnover, Gujarat WRD AA Class & PHED Class-A License) and JV Partner credentials.',
    eligibility_logic: 'Dynamic Tender Eligibility Rules: Extract target tender\'s exact financial limits (Turnover, Net Worth, Solvency, EMD) and technical work order thresholds directly from the tender document. Evaluate Option 1 (Desire Alone: ₹300.93 Cr Turnover, ₹95.00 Cr Net Worth, Gujarat AA Class / PHED Class-A), Option 2 (JV Partner Alone: Partner Turnover & Major Single Work Order), and Option 3 (Combined Consortium: 100% Financial Pooling + Joint Work Order Qualification with Desire as Lead Member).',
  ...
  ESCO: {
    ...
    system_instruction: 'ESCO Project Tender Instruction: Universally analyze Energy Service Company (ESCO) tenders for municipal street lighting, HVAC energy auditing, and industrial energy efficiency pumping. Dynamically extract target tender specifications including guaranteed energy savings percentage (SLA), BEE accreditation grade, baseline energy audit metrics, shared-savings revenue models, and performance-based O&M contracts. Evaluate extracted clauses against Desire Energy (14 Years ESCO O&M experience, BEE Grade-1 ESCO rating, ₹300.93 Cr Turnover).',
    eligibility_logic: 'Dynamic Tender Eligibility Rules: Extract target tender\'s turnover, BEE accreditation level, and energy savings SLA criteria directly from the tender document. Evaluate Option 1 (Desire Alone: ₹300.93 Cr Turnover, BEE Grade-1 ESCO Accreditation, 14 Years O&M), Option 2 (JV Partner Alone), and Option 3 (Combined Consortium).',
