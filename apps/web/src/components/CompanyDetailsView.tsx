...
export const CompanyDetailsView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 glass-card p-4 rounded-xl border border-white/10">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full bg-slate-900/80 border border-white/10 rounded-xl pl-9 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500/50"
          />
        </div>
      ...
      {/* Loading State */}
      {loading ? (
        <div className="flex flex-col items-center justify-center p-12 glass-card rounded-2xl border border-white/10 space-y-3">
          <Loader2 className="w-8 h-8 text-cyan-400 animate-spin" />
          <span className="text-xs text-slate-400 font-mono">Loading master companies database...</span>
        </div>
      ) : filteredCompanies.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-12 glass-card rounded-2xl border border-white/10 text-center space-y-3">
          ...
          {filteredCompanies.map((comp) => (
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2 p-3 rounded-xl bg-slate-900/60 border border-white/5 text-center">
                  <div>
                    <span className="text-[10px] font-mono text-slate-500 uppercase block">Avg Turnover</span>
                    <span className="text-xs font-bold text-cyan-300">₹{comp.average_turnover || 0} Cr</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="text-xs font-bold text-amber-300">₹{comp.solvency || 0} Cr</span>
                  </div>
                </div>
              ...
              <div className="pt-3 border-t border-white/10 flex items-center justify-between">
                <button
                  ...
                  className="w-full py-2 rounded-xl bg-white/5 hover:bg-cyan-500/10 text-cyan-300 hover:text-cyan-200 border border-white/10 hover:border-cyan-500/30 text-xs font-semibold flex items-center justify-center space-x-2 transition-all"
                >
      ...
      {selectedCompany && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="glass-card w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-3xl border border-white/10 p-6 md:p-8 space-y-6">
            <div className="flex items-start justify-between border-b border-white/10 pb-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-400">{selectedCompany.registered_address}</p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-slate-300">
              <div className="space-y-4">
                <div className="space-y-2">
                  <h4 className="font-semibold text-cyan-400 uppercase tracking-wider text-[11px] font-mono">Company Summary</h4>
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-cyan-400 uppercase tracking-wider text-[11px] font-mono">Contact & Representation</h4>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <h4 className="font-semibold text-cyan-400 uppercase tracking-wider text-[11px] font-mono">Financial Standings (Audited)</h4>
                  <div className="bg-slate-900/50 p-3.5 rounded-xl border border-white/5 space-y-2 font-mono">
                    <div className="flex justify-between border-b border-white/5 pb-1">
                      <span className="text-slate-400">3-Year Average Turnover:</span>
                      <span className="font-bold text-cyan-300">₹{selectedCompany.average_turnover} Cr</span>
                    </div>
                    <div className="flex justify-between border-b border-white/5 pb-1">
                      <span className="text-slate-400">Audited Net Worth:</span>
                      <span className="font-bold text-teal-300">₹{selectedCompany.net_worth} Cr</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-400">Bank Solvency Limit:</span>
                      <span className="font-bold text-amber-300">₹{selectedCompany.solvency} Cr</span>
                    </div>
                  </div>
                </div>

                <div className="space-y-2">
                  <h4 className="font-semibold text-cyan-400 uppercase tracking-wider text-[11px] font-mono">Technical & Work Orders</h4>
                  <p className="bg-slate-900/50 p-3.5 rounded-xl border border-white/5 leading-relaxed">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <form onSubmit={handleSaveCompany} className="glass-card w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl border border-white/10 p-6 md:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">Company Name *</label>
                <input
                  type="text"
                  required
                  value={formData.name || ''}
              ...
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">Company Category / Type *</label>
                <select
              ...
              <div className="md:col-span-2 space-y-1">
                <label className="text-slate-400 font-mono">Company Profile Summary</label>
                <textarea
                  rows={2}
              ...
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">Registered Address</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">Contact Person & Phone</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">GSTIN Number</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">PAN Number</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">Average Annual Turnover (₹ Cr)</label>
                <input
                  type="number"
                  step="0.01"
              ...
              <div className="space-y-1">
                <label className="text-slate-400 font-mono">Audited Net Worth (₹ Cr)</label>
                <input
                  type="number"
                  step="0.01"
              ...
              <div className="md:col-span-2 space-y-1">
                <label className="text-slate-400 font-mono">Technical Experience & Key Projects</label>
                <textarea
                  rows={2}
