  ...
  return (
    <div className="glass-card rounded-2xl p-6 border border-white/10">
      <div className="flex items-center justify-between mb-6 border-b border-white/10 pb-4">
        ...
        <div className="flex items-center space-x-2 px-3 py-1.5 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-xs font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {costStructure.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="p-4 rounded-xl bg-aqua-950/60 border border-white/8 hover:border-cyan-400/30 transition-all space-y-3"
            >
              ...
              <div className="w-full h-1.5 bg-aqua-700/60 rounded-full overflow-hidden">
                <div
