...
export const EligibilityCard: React.FC<EligibilityCardProps> = ({
    ...
    switch (verdict) {
      ...
      default:
        return {
          ...
          icon: <Shield className="w-7 h-7 text-slate-400" />,
  ...
  return (
    <div className={`glass-card rounded-2xl p-6 border border-white/10 shadow-xl ${badge.shadowColor} relative overflow-hidden`}>
      {/* Background glow orb */}
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-white/10">
        ...
        <div className={`flex items-center gap-4 glass-card px-5 py-4 rounded-2xl border ${badge.ring} self-start md:self-auto shadow-md`}>
          <div className="text-right">
            <p className="text-[11px] font-mono uppercase text-slate-400">RAG Match Score</p>
