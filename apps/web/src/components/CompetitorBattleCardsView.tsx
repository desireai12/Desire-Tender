...
export const CompetitorBattleCardsView: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      {/* Module Banner */}
      <div className="glass-card p-6 rounded-2xl border border-purple-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2 text-purple-700 font-mono text-xs mb-1">
        ...
        <div className="px-4 py-2 rounded-xl bg-purple-50 border border-purple-200 text-purple-800 font-mono text-xs text-center shrink-0">
      ...
      <div className="glass-card p-8 rounded-2xl space-y-8 border-t-4 border-t-purple-400">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-6">
          ...
          <div className="flex items-center space-x-3">
            <span className="px-3 py-1.5 rounded-xl bg-purple-50 border border-purple-200 text-purple-800 font-mono text-xs">
