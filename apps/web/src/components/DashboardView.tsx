    ...
    <div className="space-y-8 animate-fadeIn">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 rounded-xl bg-teal-700 text-aqua-950 font-bold hover:bg-teal-800 transition-all shadow-lg shadow-cyan-400/25 group"
            >
            ...
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 rounded-xl glass-card text-white hover:bg-white/10 border border-slate-250 transition-all"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div>
            <h3 className="font-display font-semibold text-lg text-white group-hover:text-teal-800 transition-colors">
              Start Guided Wizard
            </h3>
          ...
          <div className="flex items-center text-xs font-mono text-teal-700 pt-2">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-mono border border-emerald-200">
              Active Pipeline
            </span>
          </div>
          <div>
        ...
        >
          ...
          <div>
            <h3 className="font-display font-semibold text-lg text-white group-hover:text-purple-800 transition-colors">
      ...
      <div className="glass-card rounded-xl p-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-slate-50/60 border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-teal-200 transition">
            ...
            <div className="flex items-center space-x-3 self-end sm:self-center">
              <span className="px-2.5 py-1 rounded-full bg-teal-50 text-teal-700 font-mono text-xs font-bold border border-teal-200">
