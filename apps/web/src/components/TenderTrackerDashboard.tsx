...
export const TenderTrackerDashboard: React.FC<TenderTrackerDashboardProps> = ({
  ...
  const AVAILABLE_GOVT_PORTALS = [
    ...
    { name: 'Jammu and Kashmir', url: 'https://jktenders.gov.in/nicgep/app' },
    ...
    { name: 'Dadra and Nagar Haveli', url: 'https://dnhtenders.gov.in/nicgep/app' },
    { name: 'Daman and Diu', url: 'https://ddtenders.gov.in/nicgep/app' },
    { name: 'Central eProcure (CPPP 1)', url: 'https://eprocure.gov.in/eprocure/app' },
    { name: 'Central ePublish / SAIL', url: 'https://eprocure.gov.in/epublish/app' },
    { name: 'BHEL', url: 'https://eprocurebhel.co.in/nicgep/app' },
