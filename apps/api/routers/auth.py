...
REGISTERED_USERS: List[Dict[str, Any]] = [
    {
        ...
        "phone": "9829012345",
        "password_hash": hash_password("desire@2026#BD"),
        "role": "BD Executive",
    ...
    },
    {
        ...
        "phone": "9829023456",
        "password_hash": hash_password("desire@2026#Est"),
        "role": "Sr Estimator",
    ...
    },
    {
        ...
        "phone": "9829034567",
        "password_hash": hash_password("desire@2026#Eng"),
        "role": "Chief Engineer",
    ...
    },
    {
        ...
        "phone": "9829045678",
        "password_hash": hash_password("desire@2026#Tnd"),
        "role": "Tender Head",
