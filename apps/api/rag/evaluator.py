...
{{
  ...
  "clauses_breakdown": [
    {{
      ...
      "desire_value": "<Desire Energy's actual value/capability>",
      "desire_status": "MATCH" | "PARTIAL MATCH" | "NOT MATCHING" | "DATA NOT AVAILABLE",
      "desire_pct": <0-100 integer percentage>,
      "jv_value": "<JV partner's actual value/capability>",
      "jv_status": "MATCH" | "PARTIAL MATCH" | "NOT MATCHING" | "DATA NOT AVAILABLE",
      "jv_pct": <0-100 integer percentage>,
      ...
      "combined_pct": <0-100 integer percentage>,
      ...
      "fulfilled_pct": "<e.g. 100% or 85% or 0%>",
